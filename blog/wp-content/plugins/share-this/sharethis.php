...
/**
 * Add stylesheet to the frontend.
 */
function st_add_frontend_stylesheet() {
    wp_enqueue_style( 'st-widget', plugins_url('css/style.css', __FILE__) );
}
...
add_action( 'wp_enqueue_scripts', 'st_add_frontend_stylesheet' );
